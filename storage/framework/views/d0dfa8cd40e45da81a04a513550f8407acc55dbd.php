<section id="contacttres">
  <div class="container">
    <div class="section-header">
        <h2 class="section-title text-center wow fadeInDown"><?php echo e(trans('text.soportezend')); ?></h2>
        <p class="text-center wow fadeInDown"><?php echo e(trans('text.content_soporte_one')); ?></p>
    </div>
    <div class="row">
        <div class="col-sm-12">
          <div class="contact-form">
           ...
           <form action="" method="post" role="form" class="contactFormzend" id="contactzend" name="contactzend">
               ...
               <div class="col-md-12 padding-right-zero">
                 <div class="form-group">
                       <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Por favor escriba su mensaje o incidencia." placeholder="Su incidencia."></textarea>
                       <div class="validation"></div>
                   </div>
                 <button id="botomsubmitform" type="submit" class="btn btn-primary btn-submit">Enviar</button>
