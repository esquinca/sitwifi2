<section id="contactdos">
  <div class="container">
    <div class="section-header">
        <h2 class="section-title text-center wow fadeInDown"><?php echo e(trans('text.title_contacto')); ?></h2>
        <p class="text-center wow fadeInDown"><?php echo e(trans('text.content_contacto')); ?></p>
    </div>
    <div class="row">
