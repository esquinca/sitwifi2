                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="width: 570px; margin: 0 auto; padding: 0; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF;">
                  <tr>
                      <td style="padding: 35px;">
                        <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;"><?php echo e(trans('text.correolang_title')); ?></h1>
                        <p style="margin-top: 0; color: #74787E; line-height: 1.5em; font-size: 12px; text-align: left;"><strong><?php echo e(trans('text.correolang_message_one')); ?></strong><?php echo $nombre; ?></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><strong><?php echo e(trans('text.correolang_message_two')); ?></strong><?php echo $empresa; ?></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><strong><?php echo e(trans('text.correolang_message_three')); ?></strong><?php echo $email; ?></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><strong><?php echo e(trans('text.correolang_message_four')); ?></strong><?php echo $telefono; ?></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><strong><?php echo e(trans('text.correolang_message_five')); ?></strong><?php echo $producto; ?></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><strong><?php echo e(trans('text.correolang_message_ten')); ?></strong><?php echo $mensaje; ?></p>
                      </td>
                  </tr>
                </table>
              </td>
                  ...
                  <tr>
                    <td align="center" style="padding: 35px;">
                      <p style="margin-top: 0;
                          ...
                          font-size: 12px;
                          line-height: 1.5em;
                          text-align: center;">&copy; 2017 <?php echo e(trans('text.correolang_message_empresa')); ?>. <?php echo e(trans('text.correolang_message_nine')); ?>.</p>
                      <p  style="margin-top: 0;
                          color: #74787E;
                          font-size: 12px;
                          line-height: 1.5em;
                          text-align: center;">
                        <?php echo e(trans('text.correolang_message_six')); ?>

                        <br><?php echo e(trans('text.correolang_message_seven')); ?>

                        <br><?php echo e(trans('text.correolang_message_eight')); ?>
